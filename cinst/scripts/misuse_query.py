...
cursor = conn.cursor()
print("MOVE_OVERHEAD, CLASSNAME, LINE")
...
#                ''')
cops = cursor.execute(f'SELECT COP FROM CONTAINER_OP WHERE COP_NAME = "add(ILjava/lang/Object;)V" OR COP_NAME = "remove(I)Ljava/lang/Object;"').fetchall()
print(cops)
